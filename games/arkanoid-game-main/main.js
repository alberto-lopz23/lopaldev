...
let isGameOver = false; // Variable para rastrear el estado del juego

function moveBall() {
    if (isGameOver) return; // Si el juego ya ha terminado, no mover la bola
    ...
    if ( // collision paddle
        ...
        y + dy > canvas.height - ballRadius // game over
    ) {
